...
$direktori = "admin/naskah/"; // folder tempat penyimpanan file yang boleh didownload
$filename = $_GET['naskah'];
...
if ($file_extension=='php'){
  echo "<h1>Access forbidden!</h1>
        ...
        Silahkan hubungi <a href='mailto:admin@elearning.smpmuhdela.sch.id'>webmaster</a>.</p>";
  exit;
}
else{
