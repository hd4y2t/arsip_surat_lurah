...
<form action="" method="get">
	<div class="input-group col-md-5 col-md-offset-7">
		...
		<input type="text" class="form-control" placeholder="Cari Tujuan Surat di sini .." aria-describedby="basic-addon1" name="cari">		
	</div>
...
<table class="table table-hover">
	...
	if(isset($_GET['cari'])){
		$cari=$_GET['cari'];
		$berita=mysql_query("select * from surat_keluar where tujuan like '%".$cari."%'");
	}else{
