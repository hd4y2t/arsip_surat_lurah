...
<h3><span class="glyphicon glyphicon-briefcase"></span>  Data Arsip Surat</h3>
<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-plus"></span>Tambah Arsip </button>
<br/>
<br/>
...
<br>
<a style="margin-bottom:10px" href="lap_berita.php" target="_blank" class="btn btn-default pull-right"><span class='glyphicon glyphicon-print'></span> Cetak </a>
...
<table class="table table-hover">
	<tr>
		...
		<th class="col-md-2">Tanggal Masuk Surat</th>
		<th class="col-md-2">Nomor Surat</th>
		<th class="col-md-2	">Pengirim</th>
		<th class="col-md-2">Prihal</th>
	...
	if(isset($_GET['cari'])){
		$cari=$_GET['cari'];
		$berita=mysql_query("select * from surat_masuk where no_surat like '%".$cari."%'");
	}else{
...
if(isset($_GET['tanggal'])){
	...
	$tg="lap_berita.php?tanggal='$tanggal'";
...
<?php 
if(isset($_GET['tanggal'])){
	echo "<h4> Data Berita Tanggal  <a style='color:blue'> ". $_GET['tanggal']."</a></h4>";
}
?>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="tmb_berita_act.php" method="post" enctype="multipart/form-data">
					<div class="form-group">
						<label>Tanggal Masuk </label>
						<input name="tanggal" type="text" class="form-control" id="tgl1" autocomplete="off" placeholder="Tanggal Masuk">
					</div>
					<div class="form-group">
