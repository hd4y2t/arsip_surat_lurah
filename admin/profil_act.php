...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse">				
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a class="dropdown-toggle" data-toggle="dropdown" role="button" href="profil.php">Hy , <?php echo $_SESSION['uname']  ?> &nbsp &nbsp <span class="glyphicon glyphicon-user"></span></a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="col-md-2">
		...
		<ul class="nav nav-pills nav-stacked">
			<li class="active"><a href="profil.php"><span class="glyphicon glyphicon-home"></span>  Dashboard</a></li>			
