...
$pdf->Cell(25.5,0.7,"Laporan Arsip Surat Masuk",0,10,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
...
$pdf->Cell(9, 0.8, 'Nomor Surat', 1, 0, 'C');
$pdf->Cell(4, 0.8, 'Pengirim', 1, 0, 'C');
$pdf->Cell(4, 0.8, 'Prihal', 1, 0, 'C');
$pdf->Cell(4.5, 0.8, 'Sifat', 1, 1, 'C');
...
while($lihat=mysql_fetch_array($query)){
	$pdf->Cell(1, 0.8, $no , 1, 0, 'C');
	$pdf->Cell(3, 0.8, $lihat['tgl_masuk'],1, 0, 'C');
	$pdf->Cell(9, 0.8, $lihat['no_surat'], 1, 0,'C');
	$pdf->Cell(4, 0.8, $lihat['pengirim'],1, 0, 'C');
